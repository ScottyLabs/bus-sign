...
rec {
  ...
  rootCrate = rec {
    packageId = "scottylabs_bus_backend";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "scottylabs_bus_backend" = rec {
        crateName = "scottylabs_bus_backend";
        version = "0.1.0";
        edition = "2024";
        crateBin = [
          {
            name = "scottylabs_bus_backend";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./backend; };
        dependencies = [
          {
            name = "axum";
            packageId = "axum";
